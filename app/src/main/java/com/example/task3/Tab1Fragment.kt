    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val items = when (type) {
            TYPE_MY_ACTIVITIES -> listOf(
                ...
                ActivityItem.Activity("4.89км","2 часа 12 минут","Езда на велосипеде","16.03.2024",""),

                ActivityItem.SectionHeader("Позавчера"),
                ActivityItem.Activity("11.41км","4 часа","Бег","14.03.2024",""),
            )
            TYPE_USER_ACTIVITIES -> listOf(
                ActivityItem.SectionHeader("Вчера"),
                ActivityItem.Activity("162.34км","8 час 52 минуты","Езда на велосипеде","15.03.2024","@Rmgss")
